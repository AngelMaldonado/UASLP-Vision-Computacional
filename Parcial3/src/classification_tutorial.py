# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 06:49:26 2022
...
model = cv.dnn.readNet(model='DenseNet_121.caffemodel',
                       config='DenseNet_121.prototxt', framework='Caffe')
...
cv.putText(image, out_text, (25, 50),
